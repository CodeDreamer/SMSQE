; DV3 MSDOS FAT16 Sector Allocate, Locate and Truncate	V3.01  2017 W. Lenerz
; based on
...
********
	cmp.l	ddf_atotal(a4),d0	 ; valid sector?
	blo.s	ms4l_d0 		 ; ... yes
...
ms4t_loop
	...
	addq.l	#1,ddf_afree(a4)	 ; ... one more sector free
...
ms4t_cknext
	cmp.l	ddf_atotal(a4),d0	 ; valid next sector?
	blo.s	ms4t_loop		 ; ... yes
