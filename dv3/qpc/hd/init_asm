; DV3 QPC WIN Initialisation  V3.00    1992  Tony Tebby
...
;---
hd_init
	dc.w	qpc.hdcln		 ; cleanup HD driver
...
;win_drive$ fun     {DRV$},260     ; Macro does MOVEQ, i.e. val gets -ve!
win_drive$  move.l  #260,d7
	    bsr.s   fun_thg
	    dc.l    'DRV$'
