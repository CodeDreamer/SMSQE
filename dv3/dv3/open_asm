; DV3 open routines		  V3.02 	  1992 Tony Tebby
;
; 2017-11-26  3.02  Try to release removable drive after DELETE operation (MK)
...
dop_del
	...
	bra.l	dop_exit_del		 ; always try to close drive (err in d4)
...
dop_link
	...
	move.l	#d3c_qdend,(a0)
	move.l	#d3c_end-d3c_qdend,d3c_qdend(a0) ; set individual block lengths
...
dop_exit_del				 ; always try to close drive (err in d4)
	tst.b	ddf_nropen(a4)		 ; any files open?
