; DV3 Add / Remove Format Dependent Vector  V3.00           1992 Tony Tebby
...
;+++
; This is the routine that is used to remove one or more format dependent
; vectors.
;
...
dv3_addfd
        moveq   #0,d0
daf_do
daf.reg reg     d1/d2/d7/a0/a1/a2/a3
        movem.l daf.reg,-(sp)
        ...
        moveq   #-1,d1                    ; highest format type
