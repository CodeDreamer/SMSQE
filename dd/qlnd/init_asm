* Network Driver initialisation   V0.2    1985  Tony Tebby  QJUMP
*
        section nd
*
        xdef    nd_init
...
nf_def1 dc.b    %11100000,3     3 items all addresses
        ...
        dc.w    nf_open-*
        dc.w    nf_close-*
nf_def2 dc.b    %10000111,9  9 items 1 address 4 constants 3 addresses 1 rts
        dc.w    nf_formt-*
        dc.l    nf_plend
nf_name dc.w    1,'N '
        dc.w    nf_test-*
...
nd_init
        moveq   #mt.alchp,d0
        move.l  #ndd.lens+ndd.leni+ndd.lenf+ndd.lenu,d1   enough room for all
        moveq   #0,d2
        trap    #1
        tst.l   d0
        bne.s   ndi_rts
