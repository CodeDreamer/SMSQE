; Setup and unset a window definition		1993-94 Jochen Merz V0.01
	...
	xdef	ut_setups_l	  ; Setup a (scaled) window definition
	xdef	ut_setup_l	  ; Setup a fixed size window definition
...
setupreg reg	 d1/a0
	...
	move.l	d2,d1
	xjsr	ut_wm_setup	; set up the working definition with long pointer
set_exit
	rts
