; Atari SMSQ BEEP emulation    1988  Tony Tebby   QJUMP
...
hob.regx reg	 d1-d3/a0/a1/a3
	...
	moveq	#0,d1			 ; stop beeping task
	bsr.l	hob_lloc		 ; locate linkage
	bne.l	hob_exit
	lea	ho_work(a3),a0
...
hob_setl
	...
	bne.s	hob_slen
	addq.w	#1,ho_bpint(a3) 	 ; cannot have zero
hob_slen
	move.w	(a0)+,d3		 ; length
	beq.s	hob_snln
	ror.w	#8,d3
...
holl_look
	...
	move.l	d0,a3
	cmp.l	#ho.atari,ho_atari-iod_pllk(a3) ; ours?
	bne.s	holl_look			; ... no
	subq.l	#iod_pllk,a3
	move.w	d1,ho_bptim(a3) 		; ... stop beeping
	moveq	#0,d0
	rts
holl_bp
	moveq	#err.ipar,d1
