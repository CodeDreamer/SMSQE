; Atari Keyboard Spanish Tables          1993 Jochen Merz
...
kbes_tab
        ...
        dc.b    'o','p',$27,$9f,$0a,000,'a','s'
        dc.b    'd','f','g','h','j','k','l',$89 $20
        dc.b    ';',$88,000,'\','z','x','c','v'
        dc.b    'b','n','m',',','.',$ba,000,000 $30
...
*
        ...
        dc.b    '&','*','(',')','_','+',$c6,$fd
        dc.b    'Q','W','E','R','T','Y','U','I' $10
        dc.b    'O','P',$22,'^',$fe,000,'A','S'
        dc.b    'D','F','G','H','J','K','L',$a9 $20
        dc.b    ':','~',000,'|','Z','X','C','V'
