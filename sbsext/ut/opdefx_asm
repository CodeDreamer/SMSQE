...
;
; 2020-08-24  1.01  Don't add default directories on names with drives (MK)
	...
	xdef	uxt_breq	; _bas required
	xdef	uxt_sreq	; _sav required
	xdef	uxt.bas
	xdef	uxt.sav
...
;
;	d0   s
;	d1  r	lowercased letters (assumes _xxx)
;	a1 c  p pointer to filename  (rel a6)
;
;	status arbitary
;---
ut_getext
...
uxt_bopt dc.w	0
	 ...
	 dc.w	uxt..bas-*
ut_null  dc.w	0
uxt_sreq dc.w	uxt.sav-*
uxt_breq dc.w	uxt.bas-*
