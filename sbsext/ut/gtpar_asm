...
ut_gtlin
	move.l	ca..gtlin*3+qlv.off+2,d3 get long integers
	bra.s	utg_do
*
ut_gxin2
...
ut_gtint
	move.l	ca..gtint*3+qlv.off+2,d3 get integers
	bra.s	utg_do
*
ut_gxst1
	bsr.s	ut_par1 		check for one param
ut_gtstr
	move.l	ca..gtstr*3+qlv.off+2,d3 get strings
	bra.s	utg_do
*
ut_gnst1
	move.l	ca..gtstr*3+qlv.off+2,d3 get string
...
ut_gtfp
	move.l	ca..gtfp*3+qlv.off+2,d3 get floating point
	bra.s	utg_do
ut_gtfp1
	move.l	ca..gtfp*3+qlv.off+2,d3 get floating point
	bra.s	ut_get1
ut_gtin1
	move.l	ca..gtint*3+qlv.off+2,d3 get integer
	bra.s	ut_get1
ut_gtli1
	move.l	ca..gtlin*3+qlv.off+2,d3 get long integer
ut_get1
