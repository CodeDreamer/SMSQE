*       Routine to sort a set of items.
*
...
*       Registers:
*               Entry                   Exit
*       D1      interval between items  preserved
*       D2      asc./desc. order (1/-1) preserved
*       D3      number of items         preserved
...
*       Registers:
*               Entry                   Exit
*       D0,CCR                          -1 if ((A0))<((A1)), 0 if equal, 1 if >
