...
ed_xplin
	...
	move.l	pr..list*3+qlv.off+2,a2
	jsr	pro_list(a2)		but start from list from line
...
ed_setln
	...
	jsr	cn..itod*3+qlv.off	and convert to string
...
*
	...
	jsr	pa..graph*3+qlv.off	 parse using graph (a2)
	blt.s	edp_err 		 ... oops
	jsr	pa..strip*3+qlv.off	 strip spaces
	jsr	ed..newln*3+qlv.off	 edit in a newline
...
*
err_bl
	move.l	#err4.lno,d0		bad line number
...
edp_err
	...
	move.l	(a6,a0.l),a0
	jsr	ut..err*3+qlv.off	write error message
