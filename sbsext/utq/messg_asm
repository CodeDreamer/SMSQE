* Write messages and query    1985   Tony Tebby    QJUMP
*
	section utils
*
...
*
ut_messg
	lea	message(pc),a1		get message base
	add.w	d0,a1			entry in table
	add.w	(a1),a1 		address of message
ut_mesa1
...
*
ut_qynaq
	move.b	ynaq(pc),d4		assume 'Y' reply
	tst.w	d7			all?
...
*
utq_loop
	lea	ynaq(pc),a1		set pointer to replies
...
*
	...
	lea	ynaq(pc),a1		get list of reply characters
