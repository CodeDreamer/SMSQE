...
;
;	a0   s
;	a1 cr	pointer to linkage block / ptr to save area (sp_save, sp_new)
...
;
	...
	move.l	a1,-(sp)	save save area ptr
;
...
ul_move
	...
	bra.s	ul_rs_cend
ul_rs_cword
	move.l	-(a0),-(a2)	restore the right hand column
ul_rs_cend
	dbra	d4,ul_rs_cword
;
	move.w	d1,d4
ul_mv_cword
	move.l	-(a0),-(a1)	move within the save area
	dbra	d4,ul_mv_cword
;
	move.w	d0,d4
	bra.s	ul_sv_cend
ul_sv_cword
	move.l	-(a3),-(a1)	and save the new left hand column
ul_sv_cend
	dbra	d4,ul_sv_cword
;
...
ur_move
	...
	bra.s	ur_sv_cend
ur_sv_cword
	move.l	-(a3),-(a1)	save the right hand column
ur_sv_cend
	dbra	d4,ur_sv_cword
;
	move.w	d1,d4
...
;
	...
	bra.s	ur_rs_cend
ur_rs_cword
	move.l	-(a0),-(a2)	and restore the old left hand column
ur_rs_cend
	dbra	d4,ur_rs_cword
;
	sub.w	a6,a2		update the screen pointers
...
dr_move
	...
	bra.s	dr_rs_cend
dr_rs_cword
	move.l	(a0)+,(a2)+	restore the left hand column
dr_rs_cend
	dbra	d4,dr_rs_cword
;
	move.w	d1,d4
...
;
	...
	bra.s	dr_sv_cend
dr_sv_cword
	move.l	(a3)+,(a1)+	and save the new right hand column
dr_sv_cend
	dbra	d4,dr_sv_cword
;
...
dl_move
	...
	bra.s	dl_sv_cend
dl_sv_cword
	move.l	(a3)+,(a1)+	save the left hand column
dl_sv_cend
	dbra	d4,dl_sv_cword
;
	move.w	d1,d4
...
;
	...
	bra.s	dl_rs_cend
dl_rs_cword
	move.l	(a0)+,(a2)+	and restore the old right hand column
dl_rs_cend
	dbra	d4,dl_rs_cword
;
	add.w	a6,a2		update the screen pointers
