...
* v. 1.02 2013 Apr 13  provide for call back into java (wl)
*
	section driver
*
	xdef	pt_sptr
...
ptsp_do
; moving the pointer about with the robot class takes a lot of time
	dc.w	jva.trp6		; the next instructions are handled in java directly
