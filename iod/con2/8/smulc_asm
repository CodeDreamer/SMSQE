; CON2 Aurora 8 bit  Send characters to CONSOLE  V2.01	   1999 Tony Tebby
;							    2003 Marcel Kilgus
;
...
cnsm_do
	...
	sub.w	#6,a2			 ; standard print mode
...
cnsms_1of4
	ror.w	#8,d5
	move.b	d5,d4			 ; first column is solid
	ror.w	#8,d5
	bra.s	cnsm_icolr

cnsms_vert
	ror.w	#8,d5			 ; odd column is contrast
	move.b	d4,d0
	move.b	d5,d4			 ; in both lines
	move.b	d0,d5
	bra.s	cnsm_icolr

cnsms_horiz
	ror.w	#8,d4			 ; even column is different

cnsms_check
	ror.w	#8,d5			 ; odd column is different
...
cnsmi_1of4
	ror.w	#8,d7
	move.b	d7,d6			 ; first column is solid
	ror.w	#8,d7
	bra.s	cnsm_colrset

cnsmi_vert
	ror.w	#8,d7			 ; odd column is contrast
	move.b	d6,d0
	move.b	d7,d6			 ; in both lines
	move.b	d0,d7
	bra.s	cnsm_colrset

cnsmi_horiz
	ror.w	#8,d6			 ; even column is different

cnsmi_check
	ror.w	#8,d7			 ; odd column is different
...
cc_stdll
	...
	add.b	d2,d2
	bcc.s	cc_stdpap0
	move.b	d6,(a4)+		 ; ink point
	bra.s	cc_stdpx1
cc_stdpap0
	move.b	d4,(a4)+		 ; paper point

cc_stdpx1
	add.b	d2,d2
	bcc.s	cc_stdpap1
	move.b	d7,(a4)+		 ; ink point
	bra.s	cc_stdpx2
cc_stdpap1
	move.b	d5,(a4)+		 ; paper point
...
ch_stdbl
	...
	move.w	d3,d0
ch_stdbl1
	move.b	d4,(a4)+		 ; the second blank line
	move.b	d5,(a4)+
	dbra	d0,ch_stdbl1
...
cc_xorpx
	add.b	d2,d2
	bcc.s	cc_xorpap0
	eor.b	d6,(a4) 		 ; ink point
cc_xorpap0
	addq.l	#1,a4
cc_xorpx1
	add.b	d2,d2
	bcc.s	cc_xorpap1
	eor.b	d7,(a4) 		 ; ink point
cc_xorpap1
	addq.l	#1,a4
