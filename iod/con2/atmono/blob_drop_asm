* Blob dropping code    V1.02    1985   Tony Tebby  QJUMP
*
...
*
        ...
        and.w   d4,d1
        not.w   d4
        move.w  (a3),d0                 and screen
        and.w   d4,d0
        eor.w   d1,d0
        move.w  d0,(a3)+                replace green
        not.w   d4
*
snext_word
        addq.l  #4,a0                   and colour pattern
