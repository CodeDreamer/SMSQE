...
;	 trap	 #1
	lea	pat2_tab(pc),a5 	; assume mode 2
;	 tst.b	 d1			 ; is it?
...
*
	lsr.w	#3,d1			; and the address offset...   $$$$
...
*
	...
	lsr.w	#4,d0			; this many columns to fill
	bra.s	end_mid
st_mid
	bsr.s	fil_col
	addq.w	#2,a4
...
*
	moveq	#16,d0			; get pixel mask number...
...
fil_col
	...
	neg.w	d0
	addq.w	#4,d0			; going th other way
	bra.s	end_fil
st_fil
