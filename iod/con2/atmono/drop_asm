* Set-up to drop object into screen  V1.00   1985 Tony Tebby  QJUMP
*
...
*
        ...
        bra.s   set_width
to_right
        asl.w   #1,d0           set the horizontal offset of the ptr save area
set_width
...
bottom_set
        ...
        move.w  d5,d0           number of words/row
        mulu    d3,d0           * number of rows
        lsl.w   #2,d0           * bytes / long word (pattern)
        bra.s   set_height
below
