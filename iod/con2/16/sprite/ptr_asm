...
;
;	d0 cr	x address / column offset to old addres
;	d1 cr	y address / row offset to old address
;	d2  r	column of new sprite
;	d3  r	row of new sprite
...
sp_ptrscr
	add.w	d0,d0		; byte address of line
