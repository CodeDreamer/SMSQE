...
bl_line
	...
	add.l	d5,d5			(called in long words!!)

bl_word
	move.w	(a2)+,d4		set mask - blob
	and.w	(a1)+,d4		and mask = pattern
	...
	and.w	(a0)+,d4		pattern
	eor.w	d4,d0
	move.w	d0,(a3)+		update screen

	subq.w	#2,d2			decrement pointer to pattern
	bgt.s	next_d5
