;	Draw a rectangular block mode 32 with alpha blending v1.00  2016 WL/MK
;
...
*
	...
	move.w	d1,a0
	rol.w	#8,d1			; rrrrrggggggbbbbb
	move.w	d1,d2
	move.w	d1,d0

	and.l	#%0000000000011111,d0	; split into components
